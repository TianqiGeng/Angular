  ...
  template: `
   ...
   <div #modal class="modal">
    <div class="modal-content">
      <span class="close" (click)="closeModal()">&times;ffffffff</span>
...
export class AppComponent {
  _posts = [];
  _post = {};
  @ViewChild('modal', { static: false }) _myModal: any;
  ...
  showPost(postId: number) {
    return this._http.get<any>(`http://jsonplaceholder.typicode.com/posts/${postId}`).subscribe(
      res => {
        this._post = res;
