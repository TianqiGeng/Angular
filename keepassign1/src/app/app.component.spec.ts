...
const testConfig = {
  ...
  addNotes: {
    positive: {
      title: 'Read Angular 8 book again',
...
describe('AppComponent', () => {
  ...
  it('should handle 404 error on get notes', fakeAsync(() => {
    ...
    spyGetNotes = spyOn(notesService, 'getNotes').and.returnValue(throwError(errorResponse404));
  ...
  it('should handle to add a note', fakeAsync(() => {
    ...
    textArea = fixture.debugElement.nativeElement.querySelector('textarea');
    spyGetNotes = spyOn(notesService, 'getNotes').and.returnValue(of(positiveResponse));
    spyTakeNotes = spyOn(notesService, 'addNote').and.returnValue(of(addNotesPositiveResponse));
    fixture.detectChanges();
    tick();
